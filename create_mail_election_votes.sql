...
CREATE INDEX IF NOT EXISTS idx_mail_election_votes_member
ON mail_election_votes(member_id);

CREATE INDEX IF NOT EXISTS idx_mail_election_votes_agenda
ON mail_election_votes(agenda_id);
