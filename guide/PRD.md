...
- **투표 결과 입력:**
    ...
    - **현장 투표 입력 UI 개선 [UPDATED]:** 분할 투표 입력(hasSplitVoteColumns) 화면에서 불필요한 검정 박스를 제거하고, 상하 여백을 최소화하여 고밀도 UI로 개선하였습니다. 자동계산 ON/OFF 버튼은 헤더 오른쪽으로 재배치되었으며, 잔여표 찬성 채우기 버튼은 자동계산 기능과 중복되어 제거되었습니다.
